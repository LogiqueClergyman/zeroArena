...
import type { AgentLog, FundingTxReceipt, MatchReceipt, MatchUiResponse, Player, SignalDuelRoundHistory } from "../../api";
import type { GameRendererProps } from "../types";
import "./signal-duel.css";

/* ===== Signal Duel-local helpers & primitives — owned by this renderer, shared with no other game ===== */
...
export function SignalDuelRenderer(props: GameRendererProps) {
